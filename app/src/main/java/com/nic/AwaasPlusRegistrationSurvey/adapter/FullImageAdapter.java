...
import com.nic.AwaasPlusRegistrationSurvey.databinding.GalleryThumbnailBinding;
...
public class FullImageAdapter extends RecyclerView.Adapter<FullImageAdapter.MyViewHolder> {
    ...
    private List<AwaasPlusRegistrationSurvey> imagePreviewlistvalues;
    private final com.nic.AwaasPlusRegistrationSurvey.dataBase.dbData dbData;
    private LayoutInflater layoutInflater;

    public FullImageAdapter(Context context, List<AwaasPlusRegistrationSurvey> imagePreviewlistvalues, dbData dbData) {
