...
public class CommonAdapter extends BaseAdapter {
    private List<AwaasPlusRegistrationSurvey> pmgsySurveys;
    private Context mContext;
    private String type;


    public CommonAdapter(Context mContext, List<AwaasPlusRegistrationSurvey> pmgsySurvey, String type) {
...
//        TextView tv_type = (TextView) view.findViewById(R.id.tv_spinner_item);
        ...
        AwaasPlusRegistrationSurvey pmgsySurvey = pmgsySurveys.get(position);
