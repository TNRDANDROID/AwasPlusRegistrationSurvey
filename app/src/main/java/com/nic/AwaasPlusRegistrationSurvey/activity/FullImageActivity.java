...
import com.nic.AwaasPlusRegistrationSurvey.Fragment.SlideshowDialogFragment;
import com.nic.AwaasPlusRegistrationSurvey.R;
import com.nic.AwaasPlusRegistrationSurvey.adapter.FullImageAdapter;
...
import com.nic.AwaasPlusRegistrationSurvey.databinding.FullImageRecyclerBinding;
...
public class FullImageActivity extends AppCompatActivity implements View.OnClickListener, Api.ServerResponseListener {
    ...
    private static  ArrayList<AwaasPlusRegistrationSurvey> activityImage = new ArrayList<>();
    private com.nic.AwaasPlusRegistrationSurvey.dataBase.dbData dbData = new dbData(this);
    @Override
...
//        work_id = ;
    ...
    public class fetchImagetask extends AsyncTask<Void, Void,
        ...
        @Override
        protected void onPostExecute(final ArrayList<AwaasPlusRegistrationSurvey> imageList) {
    ...
    public void getOnlineImage() {
        try {
            new ApiService(this).makeJSONObjectRequest("OnlineImage", Api.Method.POST, UrlGenerator.getAwassPlusRegistrationListUrl(), ImagesJsonParams(), "not cache", this);
    ...
    public JSONObject ImagesListJsonParams() throws JSONException {
        ...
        dataSet.put(AppConstant.awaasplus_reg_id, getIntent().getStringExtra(AppConstant.awaasplus_reg_id));
    ...
    public void generateImageArrayList(JSONArray jsonArray){
        if(jsonArray.length() > 0){
            ...
            for(int i = 0; i < jsonArray.length(); i++ ) {
                try {
                    AwaasPlusRegistrationSurvey imageOnline = new AwaasPlusRegistrationSurvey();
