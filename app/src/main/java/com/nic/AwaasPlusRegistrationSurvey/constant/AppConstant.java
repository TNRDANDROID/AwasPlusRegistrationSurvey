package com.nic.AwaasPlusRegistrationSurvey.constant;
...
public class AppConstant {
    ...
    public static String KEY_PMAY_SOURCE_ALL = "awaasplus_source_data";
    ...
    public static String awaasplus_reg_id = "awaasplus_reg_id";
    public static String TYPE_OF_PHOTO = "type_of_photo";
    public static String KEY_LATITUDE = "latitude";
    public static String KEY_LONGITUDE = "longitude";
    public static String KEY_IMAGE = "image";
    public static String AWASS_PLUS_SOURCE_SAVE = "awaasplus_source_save";
    public static String KEY_TRACK_DATA = "track_data";
    public static String PMAY_ID = "pmay_id";
    public static String KEY_PMAY_SOURCE_DATA_PHOTO = "awaasplus_source_data_photo";
